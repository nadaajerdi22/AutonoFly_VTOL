...
{
  new (message_memory) px4_msgs::msg::RoverVelocitySetpoint(_init);
}

void RoverVelocitySetpoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_msgs::msg::RoverVelocitySetpoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RoverVelocitySetpoint_message_member_array[4] = {
  {
    ...
    offsetof(px4_msgs::msg::RoverVelocitySetpoint, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::RoverVelocitySetpoint, speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::RoverVelocitySetpoint, bearing),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs::msg::RoverVelocitySetpoint, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RoverVelocitySetpoint_message_members = {
  ...
  4,  // number of fields
  sizeof(px4_msgs::msg::RoverVelocitySetpoint),
...
{
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::RoverVelocitySetpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_msgs, msg, RoverVelocitySetpoint)() {
  return &::px4_msgs::msg::rosidl_typesupport_introspection_cpp::RoverVelocitySetpoint_message_type_support_handle;
}
