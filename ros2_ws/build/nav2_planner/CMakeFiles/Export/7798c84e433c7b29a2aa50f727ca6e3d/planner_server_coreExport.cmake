...
foreach(_cmake_expected_target IN ITEMS nav2_planner::planner_server_core)
...
# Create imported target nav2_planner::planner_server_core
add_library(nav2_planner::planner_server_core SHARED IMPORTED)

set_target_properties(nav2_planner::planner_server_core PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/nav2_planner"
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/planner_server_coreExport-*.cmake")
