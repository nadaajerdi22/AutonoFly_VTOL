...
# Import target "nav_2d_utils::tf_help" for configuration "Release"
set_property(TARGET nav_2d_utils::tf_help APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(nav_2d_utils::tf_help PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libtf_help.so"
  IMPORTED_SONAME_RELEASE "libtf_help.so"
  )

list(APPEND _cmake_import_check_targets nav_2d_utils::tf_help )
list(APPEND _cmake_import_check_files_for_nav_2d_utils::tf_help "${_IMPORT_PREFIX}/lib/libtf_help.so" )
